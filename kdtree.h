...
public:
   ...
   * @param isectOut [out] the intersection information; to see whether the ray
                           intersected the geometry, use intersection::hit()
   * @returns              the geom that was hit, or nullptr if none
   */
